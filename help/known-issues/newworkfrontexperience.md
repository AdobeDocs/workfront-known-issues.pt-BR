...
| -----------------------------------------------------------------| ----------------- |
| [Balanceador de carga de trabalho: as horas não se ajustam ao tempo limite do usuário](known-issues-workfront/wf-workload-balancer-assigned-hours-not-adjusting-for-pto.md) | 13 de março de 2023 |
