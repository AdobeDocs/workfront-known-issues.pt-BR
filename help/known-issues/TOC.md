...
+ [!DNL Adobe Workfront] {#new-workfront-experience}
   ...
   + Problemas atuais em [!DNL Adobe Workfront] {#wf-current}
      ...
      + [Agendamentos: não é possível visualizar exceções em anos anteriores](known-issues-workfront/wf-schedules-cannot-see-previous-year-exceptions.md)
      + [Solicitações: &quot;Todas&quot; visualização não mostra todas as solicitações](known-issues-workfront/wf-requests-not-showing-all.md)
      ...
      + [Solicitações: o rascunho criado junto com o solicitação causa problemas](known-issues-workfront/wf-requests-draft-created-with-request.md)
      ...
      + [Solicitações: problemas com rascunhos na nova solicitação experiência](known-issues-workfront/wf-requests-issues-with-drafts.md)
      + [Solicitações: as filas de solicitações aparecem várias vezes](known-issues-workfront/wf-requests-queues-duplicated.md)
      ...
      + [Relatórios: o Data Lake query não retorna os resultados esperados](known-issues-workfront/wf-reports-data-lake-not-return-expected-results.md)
      + [Relatórios: os usuários podem ver dados financeiros em visualizações do Painel de telas](known-issues-workfront/wf-reporting-users-can-see-financial-data.md)
      + [Planejamento da workfront: não é possível adicionar um campo a um visualização](known-issues-workfront/wf-planning-cannot-add-field.md)
      + [Aprovações: Meu widget de aprovações mostra aprovações concluídas](known-issues-workfront/wf-approvals-widget-shows-approved-documents.md)
      ...
      + [Tarefas: edições em linha em um tarefa não são salvas](known-issues-workfront/wf-tasks-inline-changes-not-saving.md)
      + [Usuários: A edição em massa de usuários remove os pools de recursos e os relatórios diretos](known-issues-workfront/wf-users-bulk-editing-clears-resource-pools.md)
      + [Solicitações: não é possível upload documento para solicitação do GDrive](known-issues-workfront/wf-requests-cannot-upload-from-gdrive.md)
      + [Tarefas: edita a seção Atribuições de uma tarefa não salva](known-issues-workfront/wf-tasks-assignments-changes-not-saved.md)
      ...
      + [Solicitações: permissões não herdadas ao criar um solicitação](known-issues-workfront/wf-requests-permissions-not-inherited.md)
      + [Agendamentos: permissões para agendar revogadas para uma grupo](known-issues-workfront/wf-schedules-group-permissions-revoked.md)
      + [Atribuições: as atribuições da equipe não são salvas](known-issues-workfront/wf-assignments-not-saved.md)
      + [Tarefas: horas planejadas não salvas ao criar tarefa](known-issues-workfront/wf-tasks-planned-hours-not-saving.md)
      + [Planilhas de tempo: folhas de tempo não geradas](known-issues-workfront/wf-timesheets-not-generated.md)
      ...
      + [Usuários: só podem pesquisa funções de trabalho por palavra inicial](known-issues-workfront/wf-users-job-role-first-word.md)
      + [Relatórios: problemas relacionados a listas suspensas em gráficos](known-issues-workfront/wf-reports-dropdown-not-working.md)
      ...
      + [Provas: não é possível gerar uma prova de um arquivo do PowerPoint](known-issues-workfront/wf-proofs-cannot-generate-from-pptx.md)
      ...
      + [Usuários: não é possível editar uma ID de federação do usuário](/help/known-issues/known-issues-workfront/wf-users-cannot-edit-fed-id.md)
      + [Permissões: as permissões de objeto não são herdadas corretamente](known-issues-workfront/wf-permissions-not-inherited-correctly.md)
      + [Workfront: objetos fora de sincronizar entre a Workfront e o Snowflake](/help/known-issues/known-issues-workfront/wf-users-deactivated-appear-in-snowflake.md)
      + [Provas: não é possível adicionar usuários a um prova pelo nome na Visualização ambiente](known-issues-workfront/wf-proofs-cannot-add-users-by-name-in-preview.md)
      + [Usuários: o selo &quot;Aprovação pendente&quot; é exibido em novos usuários](known-issues-workfront/wf-users-pending-approval.md)
      + [Provas: fechamento de redirecionamentos de prova para documentos lista](known-issues-workfront/wf-proofs-x-goes-to-doc-list.md)
      + [Documentos: miniaturas de documentos não são exibidas](known-issues-workfront/wf-documents-thumbnails-not-display.md)
      + [Filtros: o menu suspenso desaparece ao clicar na barra de rolagem](known-issues-workfront/wf-filter-scroll-bar.md)
      + [Projetos: o status do progresso do projeto não é atualizado automaticamente para Atraso](/help/known-issues/known-issues-workfront/wf-projects-inaccurate-condition.md)
      + [Fazer logon como: os administradores do grupo não podem fazer logon como outro usuário](known-issues-workfront/wf-login-as-group-admin-cannot-login-as.md)
      ...
      + [Documentos: não é possível upload ao AEM pasta documentos lista](/help/known-issues/known-issues-workfront/wf-documents-cannot-upload-to-aem-folder.md)
      + [Provas: não é possível tag determinados usuários](/help/known-issues/known-issues-workfront/wf-proofs-cannot-tag-users.md)
      + [Faça logon como: o layout inicial do administrador modelo é exibido](/help/known-issues/known-issues-workfront/wf-login-as-users-home-layout-not-displayed.md)
      + [Projetos: condição tardia não é aplicada conforme o esperado](/help/known-issues/known-issues-workfront/wf-projects-late-condition-not-applying.md)
      + [Relatórios: os prompts de relatório são carregados lentamente](known-issues-workfront/wf-reports-prompts-load-slowly.md)
      + [Provas: provas de webcapture não geram](known-issues-workfront/wf-proofs-webcapture-proof-not-generate.md)
      + [Aprovações: aprovações delegadas não aparecem para delegados](known-issues-workfront/wf-approvals-delegation-not-working.md)
      + [Workfront: alterações no formato de data em todo o aplicativo](known-issues-workfront/wf-workfront-date-format-changing.md)
      + [Workfront: as configurações de ZScaler podem causar desempenho reduzido](known-issues-workfront//wf-workfront-zscaler.md)
      + [Notificações: Notificações por email para atualizações que não estão sendo enviadas](known-issues-workfront/wf-notifications-emails-for-updates-not-sending.md)
      + [Workfront: usuários colaboradores não podem acessar programas ou portfólios](known-issues-workfront/wf-workfront-contributors-cant-access-programs-portfolios.md)
      ...
      + [Tarefas: duração incorreta dos dias decorridos para as tarefas pai com filhos](known-issues-workfront/wf-tasks-timeline-elapsed-days-incorrect.md)
      + [modelos de Layout: campos de dados personalizados não são exibidos quando adicionados ao Resumo de tarefas por meio Layout Modelo](known-issues-workfront/wf-layout-template-custom-data-not-diplaying.md)
      + [Integrações: as integrações jumpSeat falham para organizações no Unified Shell](known-issues-workfront/wf-integrations-jumpseat-error-with-unified-shell.md)
      + [Notificações: emails do notificação do documento não podem exibir visualizações de imagens](known-issues-workfront/wf-notifications-document-emails-missing-image-previews.md)
      + [Provas: não é possível criar provas no Visualização ambiente](known-issues-workfront/wf-proofs-cannot-create-proofs-in-preview.md)
      ...
      + [Tarefas: erro de banco de dados ao adicionar ou excluir uma tarefa (erro anteriormente Bizcontext)](known-issues-workfront/wf-tasks-bizcontext-adding-or-deleting.md)
...
+ [!DNL Workfront Proof] {#proof}
   ...
   + Problemas atuais em [!DNL Workfront Proof] {#proof-current}
      + [Prova de frente de trabalho: provas não aparecem nas pastas](known-issues-workfront-proof/proof-folders-not-showing-proofs.md)
...
+ [!DNL Adobe Workfront Fusion] {#fusion}
   ...
   + Problemas atuais em [!DNL Workfront Fusion] {#fusion-current}
      + [Workfront Fusion: erro de cabeçalho ausente nos módulos AWS](known-issues-workfront-fusion/fusion-missing-header-aws.md)
      + [Workfront Fusion: Jira Search módulo retorna um erro](known-issues-workfront-fusion/fusion-error-in-jira-search.md)
      + [Workfront Fusion: atualizações no webhook não salvam automaticamente](/help/known-issues/known-issues-workfront-fusion/fusion-must-save-updated-webhook.md)
      + [Workfront Fusion: o cenário não está em execução](known-issues-workfront-fusion/fusion-scenario-not-running.md)
      + [Workfront Fusion: Início a configuração &quot;De agora em diante&quot; processando todos os dados](known-issues-workfront-fusion/fusion-from-now-on-processing-all-data.md)
...
+ Planejamento de [!DNL Workfront] {#planning}
   + [problemas conhecidos no [!DNL Workfront] planejamento](workfrontplanning.md)

+ [!DNL Workfront] aplicativo de Publicação de conteúdo para dispositivos móveis {#mobile}
