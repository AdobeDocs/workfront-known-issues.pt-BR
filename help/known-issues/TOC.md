...
+ [!DNL Adobe Workfront] {#new-workfront-experience}
   ...
   + Problemas atuais no [!DNL Adobe Workfront] {#wf-current}
      ...
      + [Usuários: os usuários não são provisionados corretamente no Adobe Admin Console](known-issues-workfront/wf-users-on-other-consoles-not-provisioning.md)
      ...
      + [Relatórios: a consulta ao data lake não retorna os resultados esperados](known-issues-workfront/wf-reports-data-lake-not-return-expected-results.md)
      + [Relatórios: os usuários podem ver dados financeiros em visualizações do painel “Tela”](known-issues-workfront/wf-reporting-users-can-see-financial-data.md)
      + [Workfront Planning: não é possível adicionar um campo a uma visualização](known-issues-workfront/wf-planning-cannot-add-field.md)
      ...
      + [Workfront Planning: erro ao remover um campo conectado](known-issues-workfront/wf-planning-cannot-delete-connected-field.md)
      + [Usuários: a opção de gerar provas automaticamente não aparece no perfil do usuário](known-issues-workfront/wf-users-no-option-to-automatically-generate-proofs.md)
      ...
      + [Provas: as alterações nos status das provas atrasam](known-issues-workfront/wf-proof-status-sync-delayed.md)
      + [Tarefas: as edições em linha de uma tarefa não são salvas](known-issues-workfront/wf-tasks-inline-changes-not-saving.md)
      + [Usuários: a edição em massa de usuários remove os conjuntos de recursos e os subordinados diretos](known-issues-workfront/wf-users-bulk-editing-clears-resource-pools.md)
      + [Solicitações: não é possível fazer upload de documentos em solicitações no GDrive](known-issues-workfront/wf-requests-cannot-upload-from-gdrive.md)
      + [Tarefas: as edições na seção de atribuições de uma tarefa não são salvas](known-issues-workfront/wf-tasks-assignments-changes-not-saved.md)
      ...
      + [Cronogramas: permissões para agendar foram revogadas para um grupo](known-issues-workfront/wf-schedules-group-permissions-revoked.md)
      + [Atribuições: as atribuições de equipe não são salvas](known-issues-workfront/wf-assignments-not-saved.md)
      + [Tarefas: as horas planejadas não são salvas ao criar uma tarefa](known-issues-workfront/wf-tasks-planned-hours-not-saving.md)
      + [Folhas de horas: folhas de horas não geradas](known-issues-workfront/wf-timesheets-not-generated.md)
      + [Tarefas: mensagem de “Acesso insuficiente” ao editar tarefas em linha](known-issues-workfront/wf-tasks-insufficent-access-to-edit.md)
      + [Aprovações: links para aprovações indisponíveis](known-issues-workfront/wf-approvals-link-not-appearing.md)
      ...
      + [Usuários: só é possível pesquisar funções de trabalho pela primeira palavra](known-issues-workfront/wf-users-job-role-first-word.md)
      ...
      + [Formulários personalizados: a lógica de exibição de campos não é seguida corretamente](known-issues-workfront/wf-custom-forms-display-logic-triggering-incorrectly.md)
      ...
      + [Aprovações: os botões de decisão de aprovação não são exibidos no visualizador de provas](known-issues-workfront/wf-approvals-decision-buttons-not-in-proof-viewer.md)
      ...
      + [Provas: não é possível gerar uma prova a partir de um arquivo do PowerPoint](known-issues-workfront/wf-proofs-cannot-generate-from-pptx.md)
      + [Usuários: não é possível editar configurações de notificações para outro usuário](known-issues-workfront/wf-users-cannot-edit-another-users-notifications.md)
      + [Usuários: não é possível editar a Federation ID de um usuário](/help/known-issues/known-issues-workfront/wf-users-cannot-edit-fed-id.md)
      + [Permissões: as permissões de objetos não são herdadas corretamente](known-issues-workfront/wf-permissions-not-inherited-correctly.md)
      + [Workfront: objetos fora de sincronia entre o Workfront e o Snowflake](/help/known-issues/known-issues-workfront/wf-users-deactivated-appear-in-snowflake.md)
      ...
      + [Usuários: o selo de “Aprovação pendente” é exibido em novos usuários](known-issues-workfront/wf-users-pending-approval.md)
      ...
      + [Filtros: o menu suspenso desaparece ao clicar na barra de rolagem](known-issues-workfront/wf-filter-scroll-bar.md)
      + [Projetos: o status do progresso do projeto não é atualizado automaticamente para “Atrasado”](/help/known-issues/known-issues-workfront/wf-projects-inaccurate-condition.md)
      + [Fazer logon como: os administradores de grupo não podem fazer logon como outro usuário](known-issues-workfront/wf-login-as-group-admin-cannot-login-as.md)
      + [Integrações: erro de outlookIdentityToken ao usar o Workfront para Outlook](/help/known-issues/known-issues-workfront/inactive/wf-integrations-outlook-outlookidentitytoken-error.md)
      ...
      + [Formulários personalizados: empresas ausentes no campo de preenchimento automático personalizado](/help/known-issues/known-issues-workfront/wf-custom-forms-companies-missing-typeahead.md)
      + [Documentos: não é possível fazer upload para a lista de documentos da pasta do AEM](/help/known-issues/known-issues-workfront/wf-documents-cannot-upload-to-aem-folder.md)
      ...
      + [Fazer logon como: o modelo de layout da página inicial do administrador é exibido](/help/known-issues/known-issues-workfront/wf-login-as-users-home-layout-not-displayed.md)
      + [Projetos: a condição “Atrasado” não é aplicada conforme esperado](/help/known-issues/known-issues-workfront/wf-projects-late-condition-not-applying.md)
      + [Relatórios: os prompts de relatório são carregados lentamente](known-issues-workfront/wf-reports-prompts-load-slowly.md)
      + [Provas: as provas de captura da web não são geradas](known-issues-workfront/wf-proofs-webcapture-proof-not-generate.md)
      + [Aprovações: as aprovações delegadas não aparecem para delegados](known-issues-workfront/wf-approvals-delegation-not-working.md)
      + [Workfront: o formato de data muda em partes do aplicativo](known-issues-workfront/wf-workfront-date-format-changing.md)
      + [Workfront: as configurações do ZScaler podem causar uma redução do desempenho](known-issues-workfront//wf-workfront-zscaler.md)
      + [Notificações: as notificações por email de atualizações não estão sendo enviadas](known-issues-workfront/wf-notifications-emails-for-updates-not-sending.md)
      + [Workfront: os usuários colaboradores não conseguem acessar nem os programas nem os portfólios](known-issues-workfront/wf-workfront-contributors-cant-access-programs-portfolios.md)
      ...
      + [Tarefas: a duração de dias decorridos fica incorreta para tarefas principais com tarefas secundárias](known-issues-workfront/wf-tasks-timeline-elapsed-days-incorrect.md)
      ...
      + [Notificações: os emails de notificação de documentos não conseguem exibir prévias de imagens](known-issues-workfront/wf-notifications-document-emails-missing-image-previews.md)
      ...
      + [Prioridades: os agrupamentos impedem a ordenação e a edição em linha](known-issues-workfront/wf-home-priorities-grouping-limitations.md)
      + [Relatórios: não é possível rolar a tela para ver todo o relatório de gráfico](known-issues-workfront/wf-reports-unable-to-scroll.md)
      + [Grupos: os status de grupos excluídos reaparecem](known-issues-workfront/wf-groups-deleted-status-reappears.md)
      + [Documentos: comentários de prova não são exibidos em atualizações de documento](known-issues-workfront/wf-documents-proof-updates-not-copied.md)
      ...
      + [Solicitações: usuários podem alterar o status apesar de não terem permissões](known-issues-workfront/wf-requests-user-can-change-status-without-permissions.md)
      + [Relatórios: erro ao exportar o relatório](known-issues-workfront/wf-reports-error-cache-content.md)
      + [Workfront Fusion: não é possível autenticar uma conexão por meio da funcionalidade “Fazer logon como” do Workfront](known-issues-workfront/wf-fusion-cannot-use-login-as.md)
      ...
      + [A data de conclusão efetiva é exibida como N/D](known-issues-workfront/wf-projects-completion-date-is-na.md)
      ...
      + [Tarefas: erro do banco de dados ao adicionar ou excluir uma tarefa (anteriormente, erro de Bizcontext)](known-issues-workfront/wf-tasks-bizcontext-adding-or-deleting.md)
      ...
      + [[!UICONTROL Página inicial]: o widget “[!UICONTROL Menções]” na nova [!UICONTROL página inicial] não está limitado a mensagens em que o usuário está marcado](known-issues-workfront/inactive/wf-home-mentions-widget-new-home.md)
...
+ [!DNL Adobe Workfront Fusion] {#fusion}
   ...
   + Problemas atuais no [!DNL Workfront Fusion] {#fusion-current}
      ...
      + [Workfront Fusion: o módulo de pesquisa do Jira retorna um erro](known-issues-workfront-fusion/fusion-error-in-jira-search.md)
      ...
      + [Workfront Fusion: o cenário não é executado](known-issues-workfront-fusion/fusion-scenario-not-running.md)
      + [Workfront Fusion: a configuração inicial “De agora em diante” processa todos os dados](known-issues-workfront-fusion/fusion-from-now-on-processing-all-data.md)
      + [Workfront Fusion: não é possível adicionar nem excluir usuários do Workfront Fusion](known-issues-workfront-fusion/fusion-cannot-manage-users.md)
