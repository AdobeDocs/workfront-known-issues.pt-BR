...
| -----------------------------------------------------------------| ----------------- |
| [Integrações: Erro ao fazer logon no [!DNL Workfront] from [!DNL Jira]](known-issues-workfront-proof/proof-print-summary-does-not-load.md) | 24 de fevereiro de 2023 |
