...
+++**(Planejado) Atualização de manutenção em 15 de junho de 2023**
...
[!DNL Fusion] os administradores de equipe ainda podem remover conexões desnecessárias do [!UICONTROL Conexões] página em Fus[!DNL]íon.
