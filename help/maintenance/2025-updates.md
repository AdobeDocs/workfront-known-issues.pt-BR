...
+++**Semana de Atualizações de Manutenção do Workfront Planning de 16 a 22 de novembro de 2025**

### Atualizações de manutenção do Workfront Planning semana de 16 a 22 de novembro de 2025

#### Formulários personalizados

**Indicador ativo/inativo adicionado à lista de formulários personalizados em que um campo é usado**

No designer de formulário personalizado, você pode selecionar um campo e clicar em **Exibir Forms Relacionada** para exibir uma lista de todos os outros formulários nos quais o campo é usado. Isso mostra quais outros formulários serão afetados se você editar o campo.

Uma melhoria nessa lista é um indicador ativo/inativo para cada formulário. Você pode ver rapidamente se o campo é usado atualmente em formulários ativos ou inativos.

+++

+++**Semana de Atualizações de Manutenção do Workfront Planning de 9 a 15 de novembro de 2025**

### Atualizações de manutenção do Workfront Planning semana de 9 a 15 de novembro de 2025
...
+++**Semana de atualizações de manutenção de 9 a 15 de novembro de 2025**

### Atualizações de manutenção semana de 9 a 15 de novembro de 2025

#### Tarefas

**A adição de predecessores não depende mais das subconfigurações de Edição de Tarefas no nível de acesso**

Os usuários podem adicionar predecessores a tarefas quando o acesso Editar está ativado para Tarefas em seu nível de acesso, independentemente das subconfigurações selecionadas. Agora, isso está consistente com a funcionalidade existente da API.

+++

+++**Semana de atualizações de manutenção de 2 a 8 de novembro de 2025**

### Atualizações de manutenção semana de 2 a 8 de novembro de 2025

As atualizações desta semana incluem apenas correções de erros menores ou menos importantes. O Suporte da Workfront enviará uma notificação quando um problema enviado for corrigido.

+++

+++**Semana de atualizações de manutenção de 26 de outubro a 1 de novembro de 2025**

### Atualizações de manutenção semana de 26 de outubro a 1 de novembro de 2025
