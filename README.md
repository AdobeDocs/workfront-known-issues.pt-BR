...
Se você for um autor técnico, gerente de programa ou desenvolvedor da equipe de produtos de um [!DNL Adobe Experience Cloud] e seu trabalho é contribuir com ou criar artigos técnicos, você deve usar o repositório privado em `https://git.corp.adobe.com/AdobeDocs`.
